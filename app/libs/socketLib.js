    ...
    myIo.on('connection', (socket) => {
        ...
        socket.on('activate-email', (data) => {
            ...
            let mailOptions = {
                ...
                Welcome to the To Do App. It is used to create tasks with your friends and private as well.<br>Please Click <a href="http://localhost:4200/activate?activateToken=${data.activateUserToken}" >here</a> to verify your email and continue with our sevices.<br><br> Warm Regards,<br>Akki` // html body
            };
        ...
        */
        ...
        socket.on('forgot-password', (data) => {
            ...
            let mailOptions = {
                ...
                html: `Hi,<br><br>If you are receiving this email, You have forgotten the password on ToDo.<br>To reset the password Click the <a href="http://localhost:4200/reset?passwordToken=${data.resetPasswordToken}">link</a><br><b>The link will expire in 5 minutes</b><br><br>Warm Regards,<br>Akki` // html body
            };
            transporter.sendMail(mailOptions, (error, info) => {
                if (error) {
                    return console.log(error);
